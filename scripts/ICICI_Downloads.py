...
df = pd.read_csv(r"C:\Users\DUBBARS\Desktop\Cover\IC.csv", delimiter=',',usecols=cols)

downloadPath="C:\\Temp\\John\\"
...
for index, row in df.iterrows():
   ...
   # options.add_argument('headless')
    ...
    driver = webdriver.Chrome(options=options ,executable_path="C:\Temp\chromedriver.exe")
